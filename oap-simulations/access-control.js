(function () {
  ...
  const config = window.BFIN_OAP_PASSWORDS || {};
  const STORAGE_PREFIX = "bfin367_oap_unlocked_";
  const markerAttr = "data-bfin-oap-key";
  const basePath = "/financial-reporting-apps/oap-simulations/";
